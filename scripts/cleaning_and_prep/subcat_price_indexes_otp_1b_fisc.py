# -*- coding: utf-8 -*-
"""
Created on Fri Jul 25 15:23:16 2025
...
outpath = "D:/convenience_store/data/processed/LS_Otter/indexes/subcat_price_indexes_otp_1b_fisc/"
...
for store in store_numbers:
    ...
    for subcat in subcats:
        ...
        subcat_df['lag_unit_value_q'] = subcat_df.groupby(['store_id', 'gtin'])['unit_value_q'].shift(1)
        
        # Set lagged values to NaN if the time difference is not exactly 1 month
        subcat_df['lag_unit_value_q'] = np.where(subcat_df['month_diff'] == 1, subcat_df['lag_unit_value_q'], np.nan)
        ...
        stage_1_df['unit_value_index'] = (stage_1_df['unit_value_q']/stage_1_df['lag_unit_value_q'])**stage_1_df['stage_1_weight']
        ...
        category_index = (
            ...
            .agg(category_price_index = ('weighted_type_index', 'prod'))
            .reset_index()
            .rename(columns={'category_price_index': f'price_{subcat}'})
            .assign(**{f'l_price_{subcat}': lambda df: np.log(df[f'price_{subcat}'].where(df[f'price_{subcat}'] > 0, np.nan))})
...
# list of files (stores)
source_dir = "D:/convenience_store/data/processed/LS_Otter/indexes/subcat_price_indexes_otp_1b_fisc/"
...
# save indexes
indexes.to_feather('D:/convenience_store/data/processed/LS_Otter/indexes/price_otp_1b_fisc.feather')
