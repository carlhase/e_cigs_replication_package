# -*- coding: utf-8 -*-
"""
Created on Fri Aug  8 08:52:31 2025
...
outpath = "D:/convenience_store/data/processed/LS_Otter/indexes/vape_price_index_1b/"
...
for store in store_numbers:
    ...
    store_index = (
        ...
        .agg(vape_price_index_1b = ('weighted_type_index', 'prod'))
        .reset_index()
    ...
    store_index['l_vape_price_index_1b'] = np.log(store_index['vape_price_index_1b'])
...
source_dir = "D:/convenience_store/data/processed/LS_Otter/indexes/vape_price_index_1b/"
...
# save indexes
indexes.to_feather('D:/convenience_store/data/processed/LS_Otter/indexes/vape_price_index_1b.feather')
