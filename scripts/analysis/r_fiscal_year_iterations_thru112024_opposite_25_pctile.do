...
egen p_viol_25 = pctile(viol_per_100_insp), p(25)
generate viol_25 = viol_per_100_insp <= p_viol_25

egen p_insp_75 = pctile(insp_per_100k), p(75)
generate insp_75 = (insp_per_100k >= p_insp_75)

egen p_follow_75 = pctile(pct_viol_flwup_insp_12_mo), p(75)
generate follow_75 = (pct_viol_flwup_insp_12_mo >= p_follow_75)

egen p_cmp_75 = pctile(avg_cmp_collected_vs_issued), p(75)
generate cmp_75 = (avg_cmp_collected_vs_issued >= p_cmp_75)

egen p_case_file_75 = pctile(penalty_share_us_civil_cases_17), p(75)
generate case_file_75 = (penalty_share_us_civil_cases_17 >= p_case_file_75)
...
did_imputation l_vape_qty_index_1b store_id date min_treatment_date if date <= ym(2024, 11) & (follow_75 == 1 | non_rival == 1), pretrend(5) horiz(0/10) minn(0) cluster(zip_code) avgeffectsby(month_since_treatment) autosample 
estimates save "$regs\r_insp_2a_b_bsj_vape_fisc_followup_top_25_t10_thru_11_2024", replace
...
did_imputation l_vape_qty_index_1b store_id date min_treatment_date if date <= ym(2024, 11) & (cmp_75 == 1 | non_rival == 1), pretrend(5) horiz(0/10) minn(0) cluster(zip_code) avgeffectsby(month_since_treatment) autosample 
estimates save "$regs\r_insp_2a_b_bsj_vape_fisc_cmp_top_25_t10_thru_11_2024", replace

*************************************************************
// civil case rates
*******************************

did_imputation l_vape_qty_index_1b store_id date min_treatment_date if date <= ym(2024, 11) & (case_file_75 == 1 | non_rival == 1), pretrend(5) horiz(0/10) minn(0) cluster(zip_code) avgeffectsby(month_since_treatment) autosample 
estimates save "$regs\r_insp_2a_b_bsj_vape_fisc_case_top_25_t10_thru_11_2024", replace
...
estimates use "$regs\r_insp_2a_b_bsj_vape_fisc_viol_per_insp_bottom_25_t10_thru_11_2024"
xlincom (t05 = $dl_04b) (t04 = $dl_03b) (t03 = $dl_02b) (t02 = $dl_01b) (t01 = $event_baseb) (t = $dl_0b) (t1 = $dl_1b) (t2 = $dl_2b) (t3 = $dl_3b) (t4 = $dl_4b) (t5 = $dl_5b) (t6 = $dl_6b) (t7 = $dl_7b) (t8 = $dl_8b) (t9 = $dl_9b) (t10 = $dl_10b) , level(90) post
mat r = r(table)
...
mat list viol_per_insp_bottom25
    ...
    graphregion(color(white)) bgcolor(white) //ylabel(-.3(.1).3, angle(horizontal))
	graph export "${figs}r_insp_2a_b_bsj_vape_viol_per_insp_75_vs_25_defaultfe_t10_fisc_thru_11_2024.png", replace
...
estimates use "$regs\r_insp_2a_b_bsj_vape_fisc_insp_top_25_t10_thru_11_2024"
xlincom (t05 = $dl_04b) (t04 = $dl_03b) (t03 = $dl_02b) (t02 = $dl_01b) (t01 = $event_baseb) (t = $dl_0b) (t1 = $dl_1b) (t2 = $dl_2b) (t3 = $dl_3b) (t4 = $dl_4b) (t5 = $dl_5b) (t6 = $dl_6b) (t7 = $dl_7b) (t8 = $dl_8b) (t9 = $dl_9b) (t10 = $dl_10b) , level(90) post
mat r = r(table)
...
mat list insp_top_25
	...
	graph export "${figs}r_insp_2a_b_bsj_vape_insp_per_100k_25_vs_75_defaultfe_t10_fisc_thru_11_2024.png", replace
...
estimates use "$regs\r_insp_2a_b_bsj_vape_fisc_followup_top_25_t10_thru_11_2024"
xlincom (t05 = $dl_04b) (t04 = $dl_03b) (t03 = $dl_02b) (t02 = $dl_01b) (t01 = $event_baseb) (t = $dl_0b) (t1 = $dl_1b) (t2 = $dl_2b) (t3 = $dl_3b) (t4 = $dl_4b) (t5 = $dl_5b) (t6 = $dl_6b) (t7 = $dl_7b) (t8 = $dl_8b) (t9 = $dl_9b) (t10 = $dl_10b) , level(90) post
mat r = r(table)
...
mat list followup_top_25
	...
	graph export "${figs}r_insp_2a_b_bsj_vape_followup_insp_25_vs_75_defaultfe_t10_fisc_thru_11_2024.png", replace
...
estimates use "$regs\r_insp_2a_b_bsj_vape_fisc_cmp_top_25_t10_thru_11_2024"
xlincom (t05 = $dl_04b) (t04 = $dl_03b) (t03 = $dl_02b) (t02 = $dl_01b) (t01 = $event_baseb) (t = $dl_0b) (t1 = $dl_1b) (t2 = $dl_2b) (t3 = $dl_3b) (t4 = $dl_4b) (t5 = $dl_5b) (t6 = $dl_6b) (t7 = $dl_7b) (t8 = $dl_8b) (t9 = $dl_9b) (t10 = $dl_10b) , level(90) post
mat r = r(table)
...
mat list cmp_top_25
	...
	t9 = t+9 t10 = t+10) xline(5.5, lwidth(thin)) /// 
    graphregion(color(white)) bgcolor(white) //ylabel(-.15(.05).5, angle(horizontal))
	graph export "${figs}r_insp_2a_b_bsj_vape_cmp_collections_ratio_25_vs_75_defaultfe_t10_fisc_thru_11_2024.png", replace
...
estimates use "$regs\r_insp_2a_b_bsj_vape_fisc_case_top_25_t10_thru_11_2024"
xlincom (t05 = $dl_04b) (t04 = $dl_03b) (t03 = $dl_02b) (t02 = $dl_01b) (t01 = $event_baseb) (t = $dl_0b) (t1 = $dl_1b) (t2 = $dl_2b) (t3 = $dl_3b) (t4 = $dl_4b) (t5 = $dl_5b) (t6 = $dl_6b) (t7 = $dl_7b) (t8 = $dl_8b) (t9 = $dl_9b) (t10 = $dl_10b) , level(90) post
mat r = r(table)
...
mat list civil_case_top_25
    ...
    t02 = t-2 t01 = t-1 t1 = t+1 t2 = t+2 t3 = t+3 t4 = t+4 t5 = t+5 t6 = t+6 t7 = t+7 t8 = t+8 ///
	t9 = t+9 t10 = t+10) xline(5.5, lwidth(thin)) /// 
    graphregion(color(white)) bgcolor(white) //ylabel(-.4(.1).3, angle(horizontal))
	graph export "${figs}r_insp_2a_b_bsj_vape_penalty_filing_2017_25_vs_75_defaultfe_t10_fisc_thru_11_2024.png", replace
