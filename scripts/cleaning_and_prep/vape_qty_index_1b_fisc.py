...
outpath = "D:/convenience_store/data/processed/LS_Otter/indexes/vape_qty_index_1b/"
...
for store in store_numbers:
    ...
    store_index = (
        ...
        .agg(vape_qty_index_1b = ('weighted_type_index', 'prod'))
        .reset_index()
    ...
    store_index['l_vape_qty_index_1b'] = np.log(store_index['vape_qty_index_1b'])
...
source_dir = "D:/convenience_store/data/processed/LS_Otter/indexes/vape_qty_index_1b/"
...
# save indexes
indexes.to_feather('D:/convenience_store/data/processed/LS_Otter/indexes/vape_qty_index_1b.feather')
